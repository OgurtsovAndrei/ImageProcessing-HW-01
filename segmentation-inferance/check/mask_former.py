...
axs[0].set_title("Original Image (COCO)")
axs[0].axis("off")

axs[1].imshow(mask_image_pil)
axs[1].set_title("MaskFormer Semantic Mask (COCO)")
axs[1].axis("off")

axs[2].imshow(overlayed_image)
axs[2].set_title("Image with MaskFormer Overlay")
axs[2].axis("off")

plt.tight_layout()
plt.show()

print(f"Detected classes (out of {num_classes} COCO-Stuff classes):")
